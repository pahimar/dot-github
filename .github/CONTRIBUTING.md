...
Thank you so much for your interest in contributing!. All types of contributions are encouraged and valued. See the [table of contents](#how-do-i) for different ways to help and details about how this project handles them!📝
...
* Come join us in [Discord](https://discord.gg/s7Jxz6Y)
* Open an [Issue](https://github.com/pahimar/dot-github/issues)
...
* Perform a [cursory search](https://github.com/pahimar/dot-github/issues?q=is%3Aopen+is%3Aissue+label%3Abug+label%3Asupport) to see if a bug report has already been made. If it has, add a comment to the existing issue instead of opening a new one.
* Review the [tips for submitting a good bug report](#tips-for-submitting-a-good-bug-report).
* Open a [Bug Report](https://github.com/pahimar/dot-github/issues/new?assignees=&labels=&template=bug_report.md&title=).
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. Don't just explain what you did, but explain how you did it.
...
* Perform a [cursory search](https://github.com/pahimar/dot-github/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
* Review the [tips for submitting a good feature request](#tips-for-submitting-a-good-feature-request).
* Open a [Feature Request](https://github.com/pahimar/dot-github/issues/new?assignees=&labels=&template=feature_request.md&title=).
* Provide as much context as you can about what you're running into.
...
* **Include screenshots, images, and/or animated GIFs** to help provide context for your suggestion.
...
* Write clear, concise commit message(s) using the [semantic commit message](https://nitayneeman.com/posts/understanding-semantic-commit-messages-using-git-and-angular/) format. Documentation commits should use `docs(<component>): <message>`.
* Open a new [pull request](https://github.com/pahimar/dot-github/pulls) with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/pahimar/dot-github/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
In order to label issues, [open up the list of unlabeled issues](https://github.com/pahimar/dot-github/issues?q=is%3Aopen+is%3Aissue+no%3Alabel) and, **from newest to oldest**, read through each one and apply issue labels according to the table below. If you're unsure about what label to apply, skip the issue and try the next one: don't feel obligated to label each and every issue yourself!
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See [clean up issues and prs](https://github.com/pahimar/dot-github/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs) for more details."
...
When a sufficient number of changes have been merged in, or a significant milestone on the project road-map is reached, the project team will update the version of the project (following [semver](https://semver.org)) and tag a release. This will trigger a new build of the project that will become generally available to the public.
...
We believe that everyone that contributes to the project deserves to be recognized as a contributor (no matter how big or small the contribution is). We use the [All Contributors](https://allcontributors.org/) bot to add people to the [CONTRIBUTORS.md](CONTRIBUTORS.md) file, following the [bot's instructions](https://allcontributors.org/docs/en/bot/usage) and the [emoji reference key](https://allcontributors.org/docs/en/emoji-key).

## Attribution

This guide was originally generated using the WeAllJS `CONTRIBUTING.md` generator. [Make your own](https://npm.im/weallcontribute)!
